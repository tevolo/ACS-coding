...
# passing:   $imageURL,$caption,$credit,$border,$height,$width,"right"
	...
	my $Placement = $_[6];
	 print LOGFILE  " from Generic Image filename is $_[0] and placement is $Placement and credit is $credit and caption is $caption  from generic image \n";
